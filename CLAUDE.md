...
`AGENTS.md` above carries the graph location, the before-editing workflow, the 11 skills and the 13 MCP tools. This file only covers what is Claude-specific.
