...
`AGENTS.md` above carries the graph location, the before-editing workflow, the 11 skills and the 9 MCP tools. This file only covers what is Claude-specific.
