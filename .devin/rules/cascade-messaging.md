...
1. **Immediately read `.sprang/agent-conversation.md`** (use the read_file tool) — this gives you the full conversation history including any exchanges that happened earlier in this same session
